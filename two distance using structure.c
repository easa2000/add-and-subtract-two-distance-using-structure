// program to read, display, add subtract two distances; distance defined in kms and meters
#include<stdio.h>
...
int main()
{
    ...
    do
    {
        ...
        switch(option)
        {
            ...
            case 2:
                printf("\n first distance is : %d kms %d meters", d1.kms , d1.meters);
                printf("\n second distance is : %d kms %d meters", d2.kms , d2.meters);
                break;
